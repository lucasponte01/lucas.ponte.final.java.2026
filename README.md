...
*Como se usa*:
Completar el formulario de la izquierda y apretar Agregar.
Seleccionar un id y una fila de la tabla para editar.
Usar los botones de ordenar y filtrar.
Guardar y cargar datos con los botones de persistencia.
